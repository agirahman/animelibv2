...
const AnimeRecommendationsSlider = dynamic(() => import("@/components/Page/(Home)/RecommendationAnime/RecommendationAnime"), {
  ssr: true,
  loading: () => <div className="w-full aspect-[16/9] md:aspect-[21/9] bg-zinc-200 dark:bg-zinc-800 animate-pulse rounded-3xl shadow-xl" />
});

const PopularAnime = dynamic(() => import("@/components/Page/(Home)/Popular/PopularAnime"), {
  ssr: true,
  loading: () => <AnimeListSkeleton count={6} />
});

const OngoingAnime = dynamic(() => import("@/components/Page/(Home)/Ongoing/OngoingAnime"), {
  ssr: true,
  loading: () => <AnimeListSkeleton count={6} />
});

const UpcomingAnime = dynamic(() => import("@/components/Page/(Home)/Upcoming/UpcomingAnime"), {
  ssr: true,
  loading: () => <AnimeListSkeleton count={6} />
});
