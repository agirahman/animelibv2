  ...
  return (
    ...
    >
      ...
      <h1
        ...
        style={{ color: isHovered ? anime.coverImage.color || "#22c55e" : "inherit" }}
      >
      ...
      <div className="flex text-sm items-center justify-between">
        <div className="flex items-center gap-1">
          {icon}
          <span className="text-gray-500">{anime.popularity || anime.meanScore / 10}</span>
        </div>
