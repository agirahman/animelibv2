    ...
    <div className="min-h-screen pb-12">
      <div className="flex flex-col items-center justify-center mb-8 mt-4">
        <div className="flex items-center gap-3">
          <MdOutlineLeaderboard className="text-yellow-400" size={36} />
          <h1 className="text-3xl md:text-4xl font-bold">Top Anime</h1>
        </div>
        <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-center max-w-xl">
          Daftar anime dengan rating tertinggi. Temukan anime terbaik pilihan para penggemar!
        </p>
      </div>
        ...
        {api.length > 0 ? (
          ...
          <div className="col-span-full flex flex-col items-center justify-center py-20">
            ...
            <p className="text-zinc-500 max-w-md mb-8 text-center">
              Tidak ada anime populer ditemukan.
            </p>
          </div>
        )}
      </div>
